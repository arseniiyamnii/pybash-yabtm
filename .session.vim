...
inoremap <silent> <C-J> =UltiSnips#ExpandSnippet()
...
snoremap <silent> <C-J> :call UltiSnips#ExpandSnippet()
...
inoremap <expr>  fzf#vim#complete#path('find -L')
inoremap    u
cnoreabbr S source ~/.vimrc
cnoreabbr Q qa!
cnoreabbr W wqa
let &cpo=s:cpo_save
unlet s:cpo_save
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-localvimrc,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/vim-fugitive,~/.vim/plugged/ultisnips,~/.vim/plugged/vim-snippets,~/.vim/plugged/recover.vim,~/.vim/plugged/undotree,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/ale,~/.vim/plugged/vimspector,~/.vim/plugged/YouCompleteMe,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/plugged/ultisnips/after,~/.vim/after
set shiftwidth=4
set shortmess=filnxtToOc
set smartindent
set splitright
set statusline=%#LineNr#%{FugitiveStatusline()}%#LineNr#\ %f%=\ %y\ %{&fileencoding?&fileencoding:&encoding}[%{&fileformat}]\ %l/%L(%p%%)\ %c\ 
...
1
normal! 0453|
lcd ~/programming/pybash_yabtm
wincmd w
argglobal
if bufexists("~/programming/pybash_yabtm/template/.lvimrc") | buffer ~/programming/pybash_yabtm/template/.lvimrc | else | edit ~/programming/pybash_yabtm/template/.lvimrc | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>(GitGutterPrevHunk)
...
exe 'vert 2resize ' . ((&columns * 71 + 72) / 144)
tabnext
edit ~/programming/pybash_yabtm/template/LICENSE
set splitbelow splitright
set nosplitbelow
wincmd t
set winminheight=0
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 10 - ((5 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
...
tabnext 1
set stal=1
badd +5 ~/programming/pybash_yabtm/.lvimrc
badd +1 ~/programming/pybash_yabtm/template/LICENSE
badd +1 ~/programming/pybash_yabtm/yabtm.conf.json
badd +2 ~/programming/pybash_yabtm/template/README.md
badd +1 ~/programming/pybash_yabtm/README.md
badd +0 ~/programming/pybash_yabtm/template/.lvimrc
